					...
					<div className="container">
						<div className="row">
							<div className="col-lg-10 col-lg-offset-1 text-center">
								...
								<br/>
								<p className="text-muted">Made with lots of <i className="fa fa-heart" aria-hidden="true"></i> using <a href="https://facebook.github.io/react/" target="_blank"><i className="devicon-react-original"></i></a> hosted in <a href="https://pages.github.com/" target="_blank"><i className="fa fa-github fa-fw" aria-hidden="true"></i> pages</a>
							 	</p>
							</div>
						</div>
					</div>
